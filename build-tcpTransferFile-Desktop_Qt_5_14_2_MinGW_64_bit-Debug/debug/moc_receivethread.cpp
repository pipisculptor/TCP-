...
#include <memory>
#include "../../tcpTransferFile/receivethread.h"
...
QT_MOC_LITERAL(1, 14, 12), // "sendRecState"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "receiveThread\0sendRecState\0"
};
...
void receiveThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendRecState((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (receiveThread::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&receiveThread::sendRecState)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void receiveThread::sendRecState(int _t1)
{
